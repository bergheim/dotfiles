...
(add-to-list 'mu4e-headers-actions '("Email all" . bergheim/mu4e-search-from-address-all) t)
...
(add-to-list 'mu4e-headers-actions '("me directly" . bergheim/mu4e-search-to-me) t)
...
(add-to-list 'mu4e-view-actions '("Capture contact" . mu4e-action-add-org-contact) t)
...
(add-to-list 'mu4e-view-actions '("Email all" . bergheim/mu4e-search-from-address-all) t)
...
(add-to-list 'mu4e-view-actions '("me directly" . bergheim/mu4e-search-to-me) t)
